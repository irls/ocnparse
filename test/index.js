...
<w>for </w><w>the </w><w>furniture </w><w>to </w><w>hear:</w>`;
  ...
  describe('Suggestions', function() {
    ...
    describe('Suggestion inside suggestion', () => {
      let text = `<w id="9Op7G">one </w><sg data-suggestion=""><w id="agnqz">two </w><sg data-suggestion=""><w id="aIlJs" data-sugg="">three</w></sg></sg> <w id="bak2l">four</w>`;
      let check = `<w id="9Op7G">one </w><sg data-suggestion=""><w id="agnqz" data-sugg="">two <sg data-suggestion="">three</sg></w></sg> <w id="bak2l">four</w>`;
      let tokens = parser.tokenize(text, 'w');
      let rebuilt = parser.rebuild(tokens, 'w');
      let reWrap = parser.reWrap(rebuilt, 'w');
...
perished?”</w></sg>`;
  ...
  describe('Underlines', function() {
    ...
    describe('Letters i, b, u have tokens', () => {
      let text = `testi <b>i</b> testb <u>b</u> testu <i>u</i> testafter`;
      let check = `<w>testi </w><b><w>i</w></b> <w>testb </w><u><w>b</w></u> <w>testu </w><i><w>u</w></i> <w>testafter</w>`;
      let tokens = parser.tokenize(text, 'w');
      let rebuild = parser.rebuild(tokens, 'w')
      let reWrap = parser.reWrap(rebuild, 'w');
      it('Letters i, u, b have tokens, rebuild', () => expect(rebuild).to.be.equal(check));
      it('Letters i, u, b have tokens, reWrap', () => expect(reWrap).to.be.equal(check));
    });
  });
...
<w id="zkg2Q">get</w>`;
  ...
  describe('Quotes do not create separate token', () => {
    ...
    describe('Quotes after suggestion after tag', () => {
      let text = `<b><w>Letter </w><sg data-suggestion="thah, thah"><w><u>Th</u>, <u>th</u>á’ (ث):</w></sg></b> <w>above. </w><i><w>Hint: </w><w>remember </w><w>“b  </w><w>for </w><w>below, </w><w>t  </w><w>for </w><w>two, </w><u><w>th</w></u> <w>for </w><w>three.”</w></i>`;
      let check = `<b><w>Letter </w><sg data-suggestion="thah, thah"><w data-sugg="thah, thah"><u>Th</u>, <u>th</u>á’ (ث):</w></sg></b> <w>above. </w><i><w>Hint: </w><w>remember </w><w>“b  </w><w>for </w><w>below, </w><w>t  </w><w>for </w><w>two, </w><u><w>th</w></u> <w>for </w><w>three.”</w></i>`;
      let tokens = parser.tokenize(text, `w`);
      let rebuilt = parser.rebuild(tokens, `w`);
      let reWrap = parser.reWrap(rebuilt, `w`);
